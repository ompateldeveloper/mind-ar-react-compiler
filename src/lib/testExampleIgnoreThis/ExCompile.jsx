    ...
    return (
        <div>
            ...
            <div className="padding-vert--md">
                {percentage === null && <button className={clsx("button", "button--primary")} onClick={startHandler}>Start</button>}
                {percentage !== null && (
                    <div>
                        Progress: {percentage} %
                    </div>
...
export const VisualizeTab = ({ dataList, exportedBuffer }) => {
    ...
    return (
        <div>
            ...
            <div className={''}>
                <canvas style={canvasStyle} className={''} ref={canvasRef}></canvas>
            </div>
            <div className="padding-vert--md">
                <button className={clsx("button", "button--primary")} onClick={downloadHandler}>Download compiled</button>
            </div>
        </div>
    )
}
